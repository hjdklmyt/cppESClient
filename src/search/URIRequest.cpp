...
int URIRequest::addParameter( Parameters::Name name, const std::string& str ) {
...
int URIRequest::addParameter( Parameters::Name name, const char * str ) {
    if( name >= Parameters::UNKNOWN ) {
        return -1;
    }
...
int URIRequest::addParameter( Parameters::Name name, int size ) {
    if( name >= Parameters::UNKNOWN ) {
        return -1;
    }
    std::stringstream ss;
...
int URIRequest::delParameter( Parameters::Name name ) {
    if( name >= Parameters::UNKNOWN ) {
        return -1;
    }
...
std::string URIRequest::toString() {
    std::string ret = "";
